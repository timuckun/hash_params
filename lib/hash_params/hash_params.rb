class HashParams
  ...
  def self.validate_yaml_file(filename, validations={}, opts={})
  ...
  def self.validate_default_yaml_files(validations={}, opts={})
  ...
  def self.validate_hash(incoming_hash, validations={}, opts={})
  ...
  def self.set_key_value(obj, key, value, opts={})
